        ...
        <section className="pb-5">
          <div className="relative w-full overflow-hidden rounded-3xl border border-border/60 shadow-soft-xl h-[420px]">
            ...
            <div
              ...
              style={{
                background: `
                  linear-gradient(180deg, hsl(220 40% 6% / 0.55) 0%, hsl(220 40% 6% / 0.25) 35%, hsl(220 40% 6% / 0.78) 100%),
              ...
              <div className="rounded-2xl border border-white/10 bg-black/45 backdrop-blur-xl px-3 py-2.5 shadow-lg">
                <div className="flex items-start gap-2">
                  <div className="w-7 h-7 shrink-0 rounded-full bg-primary/15 flex items-center justify-center">
                    <Heart className="h-4 w-4 text-primary fill-primary/30" strokeWidth={2.2} />
                  </div>
                  <div className="min-w-0">
                    <p className="text-[12px] font-bold text-white leading-tight">Love Local</p>
                    <p className="text-[10px] text-white/65 leading-snug mt-0.5">Support the people who support Toledo.</p>
                  </div>
                </div>
              </div>
              <div className="rounded-2xl border border-white/10 bg-black/45 backdrop-blur-xl px-3 py-2.5 shadow-lg">
                <div className="flex items-start gap-2">
                  ...
                  <div className="min-w-0">
                    <p className="text-[12px] font-bold text-white leading-tight">Stronger Together</p>
                    <p className="text-[10px] text-white/65 leading-snug mt-0.5">Every connection makes an impact.</p>
                  </div>
                </div>
              </div>
            </div>
