...
export const FOUNDING_TIERS = {
  ...
  founding_50: {
    ...
    features: [
      'Free forever — all core platform access',
      'Silver Founding 50 shield badge on profile & search',
      'Priority search placement (after Founding 5, ahead of all others)',
      'Advisory participation — your voice informs platform direction',
      'Early access to new features (after Founding 5)',
      'Featured in launch marketing & press materials',
      'All Loop participation modes & Loop Burst scheduling',
      'Custom Loop multipliers up to 5×',
      'Standard analytics dashboard',
      'School & nonprofit sponsorship connections',
      'Unlimited deals, events, jobs, and offers',
    ],
    limits: {
      deals: -1,
