...
-- Guarded so preview branches (empty DB) don't fail on missing FK references.
...
WHERE EXISTS (SELECT 1 FROM public.businesses WHERE id = '1f600d35-e504-4da1-b8a4-e8b116d2a972')
  AND NOT EXISTS (
